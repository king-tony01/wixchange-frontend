...
const LIVE_API_TOKEN = `4chdgWKVWGFbfm5N4CiFqSEodS8P`;
const LIVE_API_KEY = `Q9PfqFIUl20SJKCcRDeqO8n9qrLo`;

export const vtuUrl = `https://api.mobilevtu.com/v1/${TEST_API_KEY}/`;
